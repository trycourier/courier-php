...
final class TenantsService implements TenantsContract
{
    ...
    public function retrieve(
        ...
        return $this->retrieveRaw($tenantID, $params, $requestOptions);
    }
     ...
     *
     * @return TenantListResponse<HasRawResponse>
     *
     * @throws APIException
     */
    ...
    public function delete(
        ...
        return $this->deleteRaw($tenantID, $params, $requestOptions);
    }
     ...
     * (defaults to 20, maximum value of 100)
     *
     * @return TenantListUsersResponse<HasRawResponse>
     *
     * @throws APIException
     */
