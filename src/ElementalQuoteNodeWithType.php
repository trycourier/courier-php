...
final class ElementalQuoteNodeWithType implements BaseModel
{
    ...
    /**
     * `new ElementalQuoteNodeWithType()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ElementalQuoteNodeWithType::with(content: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ElementalQuoteNodeWithType)->withContent(...)
     * ```
     */
