...
use Courier\Brands\BrandSettings\Inapp\Colors;
use Courier\Brands\BrandSettings\Inapp\Icons;
use Courier\Brands\BrandSettings\Inapp\Placement;
use Courier\Brands\BrandSettings\Inapp\WidgetBackground;
use Courier\Core\Attributes\Api;
use Courier\Core\Concerns\SdkModel;
use Courier\Core\Contracts\BaseModel;

/**
 * @phpstan-type inapp_alias = array{
 *   colors: Colors,
 *   icons: Icons,
 ...
 * }
 */
final class Inapp implements BaseModel
{
    /** @use SdkModel<inapp_alias> */
    use SdkModel;
    ...
    /**
     * `new Inapp()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Inapp::with(colors: ..., icons: ..., widgetBackground: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Inapp)->withColors(...)->withIcons(...)->withWidgetBackground(...)
     * ```
     */
