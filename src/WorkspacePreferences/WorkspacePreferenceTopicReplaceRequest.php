...
use Courier\WorkspacePreferences\WorkspacePreferenceTopicReplaceRequest\AllowedPreference;
use Courier\WorkspacePreferences\WorkspacePreferenceTopicReplaceRequest\DefaultStatus;
 ...
 * }
 */
final class WorkspacePreferenceTopicReplaceRequest implements BaseModel
{
    /** @use SdkModel<WorkspacePreferenceTopicReplaceRequestShape> */
    use SdkModel;
    ...
    /**
     * `new WorkspacePreferenceTopicReplaceRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WorkspacePreferenceTopicReplaceRequest::with(defaultStatus: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WorkspacePreferenceTopicReplaceRequest)
     *   ->withDefaultStatus(...)
     *   ->withName(...)
     * ```
     */
