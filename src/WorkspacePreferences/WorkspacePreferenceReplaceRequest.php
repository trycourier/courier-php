 ...
 * }
 */
final class WorkspacePreferenceReplaceRequest implements BaseModel
{
    /** @use SdkModel<WorkspacePreferenceReplaceRequestShape> */
    use SdkModel;
    ...
    /**
     * `new WorkspacePreferenceReplaceRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WorkspacePreferenceReplaceRequest::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WorkspacePreferenceReplaceRequest)->withName(...)
     * ```
     */
