...
use Courier\WorkspacePreferences\WorkspacePreferenceTopicGetResponse\AllowedPreference;
use Courier\WorkspacePreferences\WorkspacePreferenceTopicGetResponse\DefaultStatus;
 ...
 * }
 */
final class WorkspacePreferenceTopicGetResponse implements BaseModel
{
    /** @use SdkModel<WorkspacePreferenceTopicGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new WorkspacePreferenceTopicGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WorkspacePreferenceTopicGetResponse::with(
     *   id: ...,
     *   allowedPreferences: ...,
     *   created: ...,
     *   defaultStatus: ...,
     ...
     *
     * ```
     * (new WorkspacePreferenceTopicGetResponse)
     *   ->withID(...)
