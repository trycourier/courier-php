...
namespace Courier\Send\Recipient\UnionMember1;

use Courier\Core\Attributes\Api;
use Courier\Core\Concerns\SdkModel;
use Courier\Core\Contracts\BaseModel;
use Courier\Send\Recipient\UnionMember1\Filter\Operator;
use Courier\Send\Recipient\UnionMember1\Filter\Path;
