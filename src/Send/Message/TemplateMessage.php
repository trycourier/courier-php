 ...
 *
 * @phpstan-type template_message = array{
 *   brandID?: string|null,
 ...
 * }
 */
final class TemplateMessage implements BaseModel
{
    /** @use SdkModel<template_message> */
    use SdkModel;
    ...
    /**
     * `new TemplateMessage()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TemplateMessage::with(template: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TemplateMessage)->withTemplate(...)
     * ```
     */
