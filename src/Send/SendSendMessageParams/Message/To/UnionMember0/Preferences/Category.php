...
namespace Courier\Send\SendSendMessageParams\Message\To\UnionMember0\Preferences;

use Courier\Core\Attributes\Api;
use Courier\Core\Concerns\SdkModel;
use Courier\Core\Contracts\BaseModel;
use Courier\Send\SendSendMessageParams\Message\To\UnionMember0\Preferences\Category\ChannelPreference;
use Courier\Send\SendSendMessageParams\Message\To\UnionMember0\Preferences\Category\Rule;
use Courier\Send\SendSendMessageParams\Message\To\UnionMember0\Preferences\Category\Source;
use Courier\Send\SendSendMessageParams\Message\To\UnionMember0\Preferences\Category\Status;
