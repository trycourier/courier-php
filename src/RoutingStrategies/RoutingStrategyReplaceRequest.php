 ...
 *
 * @phpstan-type RoutingStrategyReplaceRequestShape = array{
 *   name: string,
 ...
 * }
 */
final class RoutingStrategyReplaceRequest implements BaseModel
{
    /** @use SdkModel<RoutingStrategyReplaceRequestShape> */
    use SdkModel;
    ...
    /**
     * `new RoutingStrategyReplaceRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RoutingStrategyReplaceRequest::with(name: ..., routing: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RoutingStrategyReplaceRequest)->withName(...)->withRouting(...)
     * ```
     */
