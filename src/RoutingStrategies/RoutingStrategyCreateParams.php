 ...
 *
 * @see Courier\Services\RoutingStrategiesService::create()
 *
 ...
 *
 * @phpstan-type RoutingStrategyCreateParamsShape = array{
 *   name: string,
...
{
    /** @use SdkModel<RoutingStrategyCreateParamsShape> */
    use SdkModel;
    use SdkParams;
     ...
     * ```
     * RoutingStrategyCreateParams::with(name: ..., routing: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RoutingStrategyCreateParams)->withName(...)->withRouting(...)
     * ```
     */
