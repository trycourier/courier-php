 ...
 *
 * @see Courier\Services\RoutingStrategiesService::list()
 *
 * @phpstan-type RoutingStrategyListParamsShape = array{
 *   cursor?: string|null, limit?: int|null
 * }
 */
final class RoutingStrategyListParams implements BaseModel
{
    /** @use SdkModel<RoutingStrategyListParamsShape> */
    use SdkModel;
    use SdkParams;
