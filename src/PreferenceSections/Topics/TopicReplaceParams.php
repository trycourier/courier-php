...
use Courier\PreferenceSections\Topics\TopicReplaceParams\AllowedPreference;
use Courier\PreferenceSections\Topics\TopicReplaceParams\DefaultStatus;

/**
 * Replace a topic within a section. Full document replacement; missing optional fields are cleared. Same 404 rules as GET.
 *
 * @see Courier\Services\PreferenceSections\TopicsService::replace()
 *
