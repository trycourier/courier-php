...
use Courier\PreferenceSections\PreferenceTopicReplaceRequest\AllowedPreference;
use Courier\PreferenceSections\PreferenceTopicReplaceRequest\DefaultStatus;

/**
 * Request body for replacing a preference topic. Full document replacement; missing optional fields are cleared.
 *
 * @phpstan-type PreferenceTopicReplaceRequestShape = array{
 ...
 * }
 */
final class PreferenceTopicReplaceRequest implements BaseModel
{
    /** @use SdkModel<PreferenceTopicReplaceRequestShape> */
    use SdkModel;
    ...
    /**
     * `new PreferenceTopicReplaceRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PreferenceTopicReplaceRequest::with(defaultStatus: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PreferenceTopicReplaceRequest)->withDefaultStatus(...)->withName(...)
     * ```
     */
