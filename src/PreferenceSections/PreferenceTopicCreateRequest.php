...
use Courier\PreferenceSections\PreferenceTopicCreateRequest\AllowedPreference;
use Courier\PreferenceSections\PreferenceTopicCreateRequest\DefaultStatus;

/**
 * Request body for creating a preference topic.
 *
 * @phpstan-type PreferenceTopicCreateRequestShape = array{
 ...
 * }
 */
final class PreferenceTopicCreateRequest implements BaseModel
{
    /** @use SdkModel<PreferenceTopicCreateRequestShape> */
    use SdkModel;
    ...
    /**
     * `new PreferenceTopicCreateRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PreferenceTopicCreateRequest::with(defaultStatus: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new PreferenceTopicCreateRequest)->withDefaultStatus(...)->withName(...)
     * ```
     */
