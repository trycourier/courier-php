...
namespace Courier\Journeys\Templates\TemplateReplaceParams;

use Courier\Core\Attributes\Required;
use Courier\Core\Concerns\SdkModel;
use Courier\Core\Contracts\BaseModel;
use Courier\Journeys\Templates\TemplateReplaceParams\Notification\Brand;
use Courier\Journeys\Templates\TemplateReplaceParams\Notification\Content;
use Courier\Journeys\Templates\TemplateReplaceParams\Notification\Subscription;

/**
 * @phpstan-import-type BrandShape from \Courier\Journeys\Templates\TemplateReplaceParams\Notification\Brand
 * @phpstan-import-type ContentShape from \Courier\Journeys\Templates\TemplateReplaceParams\Notification\Content
 * @phpstan-import-type SubscriptionShape from \Courier\Journeys\Templates\TemplateReplaceParams\Notification\Subscription
 *
