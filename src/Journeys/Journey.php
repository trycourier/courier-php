...
use Courier\Journeys\Journey\Version;

/**
 * A journey template representing an automation workflow.
 *
 * @phpstan-type JourneyShape = array{
 *   id: string,
 *   name: string,
 ...
 * }
 */
final class Journey implements BaseModel
{
    /** @use SdkModel<JourneyShape> */
    use SdkModel;
    ...
    /**
     * `new Journey()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Journey::with(id: ..., name: ..., version: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Journey)->withID(...)->withName(...)->withVersion(...)
     * ```
     */
