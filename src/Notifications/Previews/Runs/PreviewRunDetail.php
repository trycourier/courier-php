 ...
 *
 * @phpstan-import-type PreviewResultShape from \Courier\Notifications\Previews\Runs\PreviewResult
 *
 * @phpstan-type PreviewRunDetailShape = array{
 *   id: string,
 *   createdAt: string,
 *   deviceIDs: list<string>,
 *   results: list<PreviewResult|PreviewResultShape>,
 ...
 * }
 */
final class PreviewRunDetail implements BaseModel
{
    /** @use SdkModel<PreviewRunDetailShape> */
    use SdkModel;
     ...
     *
     * @var list<PreviewResult> $results
     */
    #[Required(list: PreviewResult::class)]
    ...
    /**
     * `new PreviewRunDetail()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PreviewRunDetail::with(
     *   id: ...,
     *   createdAt: ...,
     *   deviceIDs: ...,
     *   results: ...,
     ...
     * @param list<PreviewResult|PreviewResultShape> $results
