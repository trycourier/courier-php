...
use Courier\Users\Tokens\TokenGetSingleResponse\Status;
...
/**
 * @phpstan-type token_get_single_response = array{
 ...
 * @mixin TRawResponse
 */
final class TokenGetSingleResponse implements BaseModel
{
    /** @use SdkModel<token_get_single_response> */
    use SdkModel;
    ...
    /**
     * `new TokenGetSingleResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TokenGetSingleResponse::with(providerKey: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TokenGetSingleResponse)->withProviderKey(...)
     * ```
     */
