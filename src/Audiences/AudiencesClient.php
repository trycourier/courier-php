...
class AudiencesClient
{
     ...
     * @throws CourierApiException
     */
    public function update(string $audienceId, AudienceUpdateParams $request = new AudienceUpdateParams(), ?array $options = null): AudienceUpdateResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws CourierApiException
     */
    public function listMembers(string $audienceId, AudienceMembersListParams $request = new AudienceMembersListParams(), ?array $options = null): AudienceMemberListResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
     ...
     * @throws CourierApiException
     */
    public function listAudiences(AudiencesListParams $request = new AudiencesListParams(), ?array $options = null): AudienceListResponse
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
        if ($request->cursor != null) {
